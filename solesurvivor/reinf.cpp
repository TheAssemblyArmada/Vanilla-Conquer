            ...
            if (*thisone == AIRCRAFT_CARGO) {
                ...
                if (building) {
                    ...
                    if (Special.ModernBalance) {
                        /*
                        ** Cargo plane takes 5 seconds to reach the airstrip on Normal (1.5x legacy), or (75 / 10)
                        *seconds at speed.
        ...
        if (team) {
            ...
            */
            ...
            if (mission == TMISSION_NONE) {
                if (another
                    && (another->What_Am_I() != RTTI_UNITTYPE || ((UnitTypeClass const*)another)->Type != UNIT_HOVER)) {
