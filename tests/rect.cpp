...
int test_rect()
{
    ...
    for (const Test_data& test : test_data) {
        ...
        int outClip =
            Clip_Rect(&outClipRect.X, &outClipRect.Y, &outClipRect.Width, &outClipRect.Height, test.width, test.height);
        Rect outConfineRect = test.rect;
        int outConfine = Confine_Rect(
            &outConfineRect.X, &outConfineRect.Y, outConfineRect.Width, outConfineRect.Height, test.width, test.height);
