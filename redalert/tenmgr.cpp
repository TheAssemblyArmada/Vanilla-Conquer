 ...
 *   07/22/1996 BRR : Created.                                             *
 *=========================================================================*/
int TenConnManClass::Send_Private_Message(void* buf, int buflen, int reliable, int conn_id)
{
 ...
 *   07/22/1996 BRR : Created.                                             *
 *=========================================================================*/
int TenConnManClass::Send_Global_Message(void* buf, int buflen, int reliable, int address)
{
...
void TenConnManClass::Flush_All(void)
{
    ...
    //
    maxqueuesize = 45;
    rc = tenArSetOption(kTenArOptReadQueueSize, &maxqueuesize, sizeof(maxqueuesize));
    ...
    while (i++ < 1000) {
        tenArIdleArena();
        if (GlobalQueue->Num_Receive() == 0 && PrivateQueue->Num_Receive() == 0) {
            break;
        }
        GlobalQueue->Init();
        PrivateQueue->Init();
 ...
 *   07/22/1996 BRR : Created.                                             *
 *=========================================================================*/
void TenConnManClass::Configure_Debug(int /*index*/,
                                      int /*type_offset*/,
                                      int /*type_size*/,
                                      char** /*names*/,
                                      int /*namestart*/,
