 ...
 *   11/28/1995 JLB : Created.                                                                 *
 *=============================================================================================*/
bool TEventClass::operator()(TDEventClass& td,
                             TEventType event,
                             HousesType house,
                             ObjectClass const* object,
                             bool forced)
{
    /*
    ...
    */
    ...
    case TEVENT_GLOBAL_SET:
        if (!Scen.GlobalFlags[Data.Value])
            return (false);
        return (true);
    ...
    **	event identifier.
    */
    if (Event == TEVENT_ATTACKED || Event == TEVENT_DESTROYED || Event == TEVENT_DISCOVERED || Event == TEVENT_SPIED
        || Event == TEVENT_NONE || Event == TEVENT_CROSS_HORIZONTAL || Event == TEVENT_CROSS_VERTICAL
        || Event == TEVENT_ENTERS_ZONE || Event == TEVENT_PLAYER_ENTERED) {
    ...
    if (hptr != NULL) {
        ...
        */
        case TEVENT_NBUILDINGS_DESTROYED:
            if ((int)hptr->BuildingsLost < Data.Value)
                return (false);
            break;
        ...
        */
        case TEVENT_NUNITS_DESTROYED:
            if ((int)hptr->UnitsLost < Data.Value)
                return (false);
            break;
