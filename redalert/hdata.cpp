...
static HouseTypeClass const HouseEngland(HOUSE_ENGLAND,
...
static HouseTypeClass const HouseGermany(HOUSE_GERMANY,
...
static HouseTypeClass const HouseFrance(HOUSE_FRANCE,
...
static HouseTypeClass const HouseUkraine(HOUSE_UKRAINE,
...
static HouseTypeClass const HouseUSSR(HOUSE_USSR,
...
static HouseTypeClass const HouseGreece(HOUSE_GREECE,
...
static HouseTypeClass const HouseTurkey(HOUSE_TURKEY,
...
static HouseTypeClass const HouseSpain(HOUSE_SPAIN,
...
HouseTypeClass const* const HouseTypeClass::Pointers[HOUSE_COUNT] = {
    &HouseSpain,  &HouseGreece, &HouseUSSR,   &HouseEngland,  &HouseUkraine, &HouseGermany, &HouseFrance,
    &HouseTurkey, &HouseGood,   &HouseBad,    &HouseCivilian, &HouseJP,      &HouseMulti1,  &HouseMulti2,
    &HouseMulti3, &HouseMulti4, &HouseMulti5, &HouseMulti6,   &HouseMulti7,  &HouseMulti8,
};
#endif
