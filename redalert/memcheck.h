...
*/
#define mc_breakpoint(_f)       mc_set_trackf((mc_set_breakfile(_f), trackf_breakpoint))
#define mc_breakpoint_trace(_f) mc_set_trackf((mc_set_tracefile(_f), trackf_breakpoint_trace))

/* *** Advanced-user API extenders *** */

/*  extern  int     _MCAPI mc_find_buffer(void _MCFAR *, MEMRECP);  */
extern int _MCAPI mc_check_transfer(void _MCFAR*, void _MCFAR*, unsigned long, unsigned, unsigned, MEMRECP);
...
extern void _MCFAR _MCCDECL
ssfh_info(short const, unsigned short const, unsigned short const, unsigned const, short const);

extern void _MCFAR _MCCDECL
ssfh_fast(short const, unsigned short const, unsigned short const, unsigned const, short const);
/*  int         const   _flag,      */

extern void _MCFAR _MCCDECL
ssfh_standard(short const, unsigned short const, unsigned short const, unsigned const, short const);

extern void _MCFAR _MCCDECL
ssfh_debug(short const, unsigned short const, unsigned short const, unsigned const, short const);
...
/*  Link-time defaults.
    ...
    must generally have link-time initializations:
        ...
        MC_SET_STARTF()
*/
#define MC_SET_AUTOINIT(_toggle)    char _MCVAR MC_UserAutoInit = (_toggle);
#define MC_SET_CHECKF(_f)           CHECKF _MCVAR MC_CheckF = (_f)
#define MC_SET_CHECK_FREQ(_freq)    int _MCVAR MC_CheckFreq = (_freq)
#define MC_SET_CRITF(_f)            MCCRITF _MCVAR MC_CritF = (_f)
#define MC_SET_ENDF(_f)             ENDF _MCVAR MC_EndF = (_f)
#define MC_SET_ENV_VAR(_envvarname) char* _MCVAR MC_EnvVar = (_envvarname)
#define MC_SET_ERF(_f)              ERF _MCVAR MC_ERF = (_f)
#define MC_SET_EXCEPTF(_f)          MCEXCEPTF _MCVAR MC_ExceptF = (_f)
#define MC_SET_GLOBALF(_f)          GLOBALF _MCVAR MC_GlobalF = (_f)
#define MC_SET_GLOBALEXITF(_f)      GLOBALF _MCVAR MC_GlobalExitF = (_f)
#define MC_SET_LOGFILE(_f)          char* _MCVAR MC_LogFile = (_f)
#define MC_SET_PANIC_BUFFERS(_q)    unsigned char _MCVAR MC_PanicBufCount = (_q)
#define MC_SET_SSFH(_f)             _SSFRAMEHANDLER _MCVAR near MC_SFrameHandler = (_f)
#define MC_SET_STARTF(_f)           STARTF _MCVAR MC_StartF = (_f)
#define MC_SET_TRACKF(_f)           TRACKF _MCVAR MC_TrackF = (_f)
#define MC_SET_VERIFYF(_f)          VERIFYF _MCVAR MC_VerifyF = (_f)
...
*/
#define _RTLDECL(f, rctype, params) extern rctype _RTL RTL(f) params
