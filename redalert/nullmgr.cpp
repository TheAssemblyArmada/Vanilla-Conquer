 ...
 *=========================================================================*/
void NullModemClass::Configure_Debug(int, int type_offset, int type_size, char** names, int namestart, int namecount)
{
    if (Connection)
        Connection->Queue->Configure_Debug(type_offset, type_size, names, namestart, namecount);
}
