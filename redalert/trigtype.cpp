...
bool TriggerTypeClass::Edit(void)
{
    ...
    */
    ...
    TDropListClass<EventChoiceClass*> event1list(EVENT_LIST,
                                                 eventtext,
                                                 sizeof(eventtext),
    ...
    TDropListClass<EventChoiceClass*> event2list(EVENT_LIST2,
                                                 event2text,
                                                 sizeof(event2text),
                                                 TPF_EFNT | TPF_NOSHADOW,
                                                 E2_X,
    ...
    */
    ...
    TDropListClass<ActionChoiceClass*> action1list(ACTION_LIST,
                                                   actiontext,
                                                   sizeof(actiontext),
                                                   TPF_EFNT | TPF_NOSHADOW,
                                                   A1_X,
    ...
    TDropListClass<ActionChoiceClass*> action2list(ACTION_LIST2,
                                                   action2text,
                                                   sizeof(action2text),
                                                   TPF_EFNT | TPF_NOSHADOW,
                                                   A2_X,
    ...
    */
    ...
    EditClass way1data(
        DATA_EDIT, way1, sizeof(way1), TPF_EFNT | TPF_NOSHADOW, ED1_X, ED1_Y, ED_WIDTH, 9, EditClass::ALPHA);
    ...
    EditClass way2data(
        DATA_EDIT2, way2, sizeof(way2), TPF_EFNT | TPF_NOSHADOW, ED2_X, ED2_Y, ED_WIDTH, 9, EditClass::ALPHA);
    ...
    EditClass way3data(
        DATA_EDIT3, way3, sizeof(way3), TPF_EFNT | TPF_NOSHADOW, AD1_X, AD1_Y, ED_WIDTH, 9, EditClass::ALPHA);
    ...
    EditClass way4data(
        DATA_EDIT4, way4, sizeof(way4), TPF_EFNT | TPF_NOSHADOW, AD2_X, AD2_Y, ED_WIDTH, 9, EditClass::ALPHA);
    ...
    */
    ...
    EditClass event1data(DATA_GENERAL1,
                         databuf1,
                         sizeof(databuf1),
                         TPF_EFNT | TPF_NOSHADOW,
                         ED1_X,
    ...
    EditClass event2data(DATA_GENERAL2,
                         databuf2,
                         sizeof(databuf2),
                         TPF_EFNT | TPF_NOSHADOW,
                         ED2_X,
    ...
    EditClass action1data(DATA_GENERAL3,
                          actionbuf1,
                          sizeof(actionbuf1),
                          TPF_EFNT | TPF_NOSHADOW,
                          AD1_X,
    ...
    EditClass action2data(DATA_GENERAL4,
                          actionbuf2,
                          sizeof(actionbuf2),
                          TPF_EFNT | TPF_NOSHADOW,
                          AD2_X,
    ...
    */
    ...
    DropListClass ttype1list(DATA_TTYPE1,
                             tbuf1,
                             sizeof(tbuf1),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED1_X,
    ...
    DropListClass ttype2list(DATA_TTYPE2,
                             tbuf2,
                             sizeof(tbuf2),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED2_X,
    ...
    DropListClass ttype3list(DATA_TTYPE3,
                             tbuf3,
                             sizeof(tbuf3),
                             TPF_EFNT | TPF_NOSHADOW,
                             AD1_X,
    ...
    DropListClass ttype4list(DATA_TTYPE4,
                             tbuf4,
                             sizeof(tbuf4),
                             TPF_EFNT | TPF_NOSHADOW,
                             AD2_X,
    ...
    */
    ...
    DropListClass trtype1list(DATA_TRTYPE1,
                              trbuf1,
                              sizeof(trbuf1),
                              TPF_EFNT | TPF_NOSHADOW,
                              AD1_X,
    ...
    DropListClass trtype2list(DATA_TRTYPE2,
                              trbuf2,
                              sizeof(trbuf2),
                              TPF_EFNT | TPF_NOSHADOW,
                              AD2_X,
    ...
    */
    ...
    DropListClass booltype1list(DATA_BOOLTYPE1,
                                boolbuf1,
                                sizeof(boolbuf1),
                                TPF_EFNT | TPF_NOSHADOW,
                                AD1_X,
    ...
    DropListClass booltype2list(DATA_BOOLTYPE2,
                                boolbuf2,
                                sizeof(boolbuf2),
                                TPF_EFNT | TPF_NOSHADOW,
                                AD2_X,
    ...
    */
    ...
    DropListClass themetype1list(DATA_THEME1,
                                 themebuf1,
                                 sizeof(themebuf1),
                                 TPF_EFNT | TPF_NOSHADOW,
                                 AD1_X,
    ...
    DropListClass themetype2list(DATA_THEME2,
                                 themebuf2,
                                 sizeof(themebuf2),
                                 TPF_EFNT | TPF_NOSHADOW,
                                 AD2_X,
    ...
    */
    ...
    DropListClass movietype1list(DATA_MOVIE1,
                                 moviebuf1,
                                 sizeof(moviebuf1),
                                 TPF_EFNT | TPF_NOSHADOW,
                                 AD1_X,
    ...
    DropListClass movietype2list(DATA_MOVIE2,
                                 moviebuf2,
                                 sizeof(moviebuf2),
                                 TPF_EFNT | TPF_NOSHADOW,
                                 AD2_X,
    ...
    */
    ...
    DropListClass soundtype1list(DATA_SOUND1,
                                 soundbuf1,
                                 sizeof(soundbuf1),
                                 TPF_EFNT | TPF_NOSHADOW,
                                 AD1_X,
    ...
    DropListClass soundtype2list(DATA_SOUND2,
                                 soundbuf2,
                                 sizeof(soundbuf2),
                                 TPF_EFNT | TPF_NOSHADOW,
                                 AD2_X,
    ...
    */
    ...
    DropListClass speechtype1list(DATA_SPEECH1,
                                  speechbuf1,
                                  sizeof(speechbuf1),
                                  TPF_EFNT | TPF_NOSHADOW,
                                  AD1_X,
    ...
    DropListClass speechtype2list(DATA_SPEECH2,
                                  speechbuf2,
                                  sizeof(speechbuf2),
                                  TPF_EFNT | TPF_NOSHADOW,
                                  AD2_X,
    ...
    */
    ...
    DropListClass btype1list(DATA_BTYPE1,
                             bbuf1,
                             sizeof(bbuf1),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED1_X,
    ...
    DropListClass btype2list(DATA_BTYPE2,
                             bbuf2,
                             sizeof(bbuf2),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED2_X,
    ...
    */
    ...
    DropListClass itype1list(DATA_ITYPE1,
                             ibuf1,
                             sizeof(ibuf1),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED1_X,
    ...
    DropListClass itype2list(DATA_ITYPE2,
                             ibuf2,
                             sizeof(ibuf2),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED2_X,
    ...
    */
    ...
    DropListClass atype1list(DATA_ATYPE1,
                             abuf1,
                             sizeof(abuf1),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED1_X,
    ...
    DropListClass atype2list(DATA_ATYPE2,
                             abuf2,
                             sizeof(abuf2),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED2_X,
    ...
    */
    ...
    DropListClass utype1list(DATA_UTYPE1,
                             ubuf1,
                             sizeof(ubuf1),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED1_X,
    ...
    DropListClass utype2list(DATA_UTYPE2,
                             ubuf2,
                             sizeof(ubuf2),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED2_X,
    ...
    */
    ...
    DropListClass htype1list(DATA_HTYPE1,
                             housebuf1,
                             sizeof(housebuf1),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED1_X,
    ...
    DropListClass htype2list(DATA_HTYPE2,
                             housebuf2,
                             sizeof(housebuf2),
                             TPF_EFNT | TPF_NOSHADOW,
                             ED2_X,
    ...
    DropListClass htype3list(DATA_HTYPE3,
                             housebuf3,
                             sizeof(housebuf3),
                             TPF_EFNT | TPF_NOSHADOW,
                             AD1_X,
    ...
    DropListClass htype4list(DATA_HTYPE4,
                             housebuf4,
                             sizeof(housebuf4),
                             TPF_EFNT | TPF_NOSHADOW,
                             AD2_X,
    ...
    */
    ...
    DropListClass spc1(DATA_SPECIAL1,
                       special1,
                       sizeof(special1),
                       TPF_EFNT | TPF_NOSHADOW,
                       AD1_X,
    ...
    DropListClass spc2(DATA_SPECIAL2,
                       special2,
                       sizeof(special2),
                       TPF_EFNT | TPF_NOSHADOW,
                       AD2_X,
    ...
    */
    ...
    DropListClass qlist1(DATA_SPECIAL1,
                         quarry1,
                         sizeof(quarry1),
                         TPF_EFNT | TPF_NOSHADOW,
                         AD1_X,
    ...
    DropListClass qlist2(DATA_SPECIAL2,
                         quarry2,
                         sizeof(quarry2),
                         TPF_EFNT | TPF_NOSHADOW,
                         AD2_X,
    ...
    */
    ...
    TextButtonClass eventbtn(
        BUTTON_EVENT, TXT_TRIGGER_JUST_EVENT, TPF_EBUTTON, event1list.X, event1list.Y + 11, 100, 9);
    ...
    */
    ...
    TextButtonClass actionbtn(
        BUTTON_ACTION, TXT_TRIGGER_JUST_ACTION, TPF_EBUTTON, action1list.X, action1list.Y + 11, 100, 9);
    ...
    */
    ...
    TextButtonClass cancelbtn(
        BUTTON_CANCEL, TXT_CANCEL, TPF_EBUTTON, D_DIALOG_X + D_DIALOG_W - 80, D_DIALOG_Y + D_DIALOG_H - 30, 45, 9);
        ...
        */
        if (display /*&& LogicPage->Lock()*/) {
            ...
            */
            ...
            Fancy_Text_Print(
                "Action to Perform:", action1list.X, action1list.Y - 7, scheme, TBLACK, TPF_EFNT | TPF_NOSHADOW);
            ...
            if (eventflag == 3) {
                LogicPage->Draw_Line(
                    event1list.X - 1, event1list.Y + 3, event1list.X - 2 * RESFACTOR, event1list.Y + 3, WHITE);
                LogicPage->Draw_Line(event1list.X - 2 * RESFACTOR,
                                     event1list.Y + 3,
                                     action1list.X - 2 * RESFACTOR,
                                     action1list.Y + 3,
                                     WHITE);
                LogicPage->Draw_Line(
                    action1list.X - 1, action1list.Y + 3, action1list.X - 2 * RESFACTOR, action1list.Y + 3, WHITE);

                LogicPage->Draw_Line(
                    event2list.X - 1, event2list.Y + 3, event2list.X - 5 * RESFACTOR, event2list.Y + 3, WHITE);
                LogicPage->Draw_Line(event2list.X - 5 * RESFACTOR,
                                     event2list.Y + 3,
                                     action2list.X - 5 * RESFACTOR,
                                     action2list.Y + 3,
                                     WHITE);
                LogicPage->Draw_Line(
                    action2list.X - 1, action2list.Y + 3, action2list.X - 5 * RESFACTOR, action2list.Y + 3, WHITE);
            }
