...
int MapEditClass::Load_Scenario(void)
{
    ...
    */
    ...
    int MapEditClass::Pick_Scenario(
        char const* caption, int& scen_nump, ScenarioPlayerType& playerp, ScenarioDirType& dirp, ScenarioVarType& varp)
    {
        /*
    ...
    EditClass editbtn(BUTTON_SCENARIO,
        ...
        TextButtonClass playermbtn(
            BUTTON_MPLAYER, "Multiplayer", TPF_EBUTTON, D_MPLAYER_X, D_MPLAYER_Y, D_MPLAYER_W, D_MPLAYER_H);
        ...
        TextButtonClass cancelbtn(
            BUTTON_CANCEL, TXT_CANCEL, TPF_EBUTTON, D_CANCEL_X, D_CANCEL_Y, D_CANCEL_W, D_CANCEL_H);
                    ...
                    */
                    if (LogicPage->Lock()) {
                        ...
                        */
                        ...
                        txt_y = D_BORD_Y1;
                        Plain_Text_Print(
                            "Clear Terrain", txt_x, txt_y, GroundColor[LAND_CLEAR], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "Water", txt_x, txt_y, GroundColor[LAND_WATER], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "Tiberium", txt_x, txt_y, GroundColor[LAND_TIBERIUM], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "Rock", txt_x, txt_y, GroundColor[LAND_ROCK], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "Wall", txt_x, txt_y, GroundColor[LAND_WALL], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "Beach", txt_x, txt_y, GroundColor[LAND_BEACH], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "Rough", txt_x, txt_y, GroundColor[LAND_ROUGH], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        txt_y += 8;
                        Plain_Text_Print(
                            "River", txt_x, txt_y, GroundColor[LAND_RIVER], TBLACK, TPF_DROPSHADOW | TPF_EFNT);
                        //					txt_y += 8;
                        //					Plain_Text_Print("GDI Unit", txt_x, txt_y, YELLOW, TBLACK, TPF_DROPSHADOW |
                        //TPF_EFNT); 					txt_y += 8; 					Plain_Text_Print("Nod Unit", txt_x, txt_y, RED, TBLACK, TPF_DROPSHADOW
                        //| TPF_EFNT); 					txt_y += 8; 					Plain_Text_Print("Neutral Unit", txt_x, txt_y, PURPLE, TBLACK,
    ...
    int MapEditClass::Scenario_Dialog(void)
    {
        ...
        */
        ...
        StaticButtonClass techstatic(
            0, "999", TPF_EFNT | TPF_NOSHADOW, techlevel.X + techlevel.Width - 20, techlevel.Y - 7);
        ...
        */
        ...
        StaticButtonClass creditstatic(
            0, "999999999", TPF_EFNT | TPF_NOSHADOW, creditbtn.X + creditbtn.Width - 50, creditbtn.Y - 7);
        ...
        */
        ...
        StaticButtonClass maxunitstatic(
            0, "999999", TPF_EFNT | TPF_NOSHADOW, maxunit.X + maxunit.Width - 30, maxunit.Y - 7);
        ...
        */
        ...
        StaticButtonClass smartiesstatic(
            0, "9999", TPF_EFNT | TPF_NOSHADOW, smarties.X + smarties.Width - 20, smarties.Y - 7);
            ...
            if (display) {
                ...
                */
                ...
                Fancy_Text_Print("Theme:",
                                 ...
                                 TPF_EFNT | TPF_NOSHADOW);
                Fancy_Text_Print(
                    "Intro:", intro.X, intro.Y - 7, GadgetClass::Get_Color_Scheme(), TBLACK, TPF_EFNT | TPF_NOSHADOW);
                ...
                Fancy_Text_Print("Action:",
                                 ...
                                 TPF_EFNT | TPF_NOSHADOW);
                Fancy_Text_Print(
                    "Win:", win.X, win.Y - 7, GadgetClass::Get_Color_Scheme(), TBLACK, TPF_EFNT | TPF_NOSHADOW);
                Fancy_Text_Print(
                    "Lose:", lose.X, lose.Y - 7, GadgetClass::Get_Color_Scheme(), TBLACK, TPF_EFNT | TPF_NOSHADOW);
