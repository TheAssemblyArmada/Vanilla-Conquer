 ...
 *=============================================================================================*/
void ChronalVortexClass::Coordinate_Remap(GraphicViewPortClass* inbuffer,
                                          int x,
                                          int y,
                                          int width,
                                          int height,
            ...
            for (int y = 0; y < 4; y++) {
                for (int x = 0; x < 4; x++) {
                    ...
                    if (cell != -1) {
                        ...
                        */
                        if (cellptr->TType != TEMPLATE_NONE && cellptr->TType != TEMPLATE_CLEAR1
                            && cellptr->TType != 255) {
                        ...
                        */
                        if (ttype->Get_Image_Data()) {
                            RenderBuffer->Draw_Stamp(
                                ttype->Get_Image_Data(), icon, x * CELL_PIXEL_W, y * CELL_PIXEL_H, NULL, WINDOW_MAIN);
                        }
                        ...
                        */
                        if (cellptr->Overlay != OVERLAY_NONE) {
                            ...
                            IsTheaterShape =
                                (bool)otype.IsTheater; // Tell Build_Frame if this overlay is theater specific
