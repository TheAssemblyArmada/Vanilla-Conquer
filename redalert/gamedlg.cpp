...
void GameControlsClass::Process(void)
{
    ...
    */
    ...
    TextButtonClass visual_btn(
        BUTTON_VISUAL, TXT_VISUAL_CONTROLS, TPF_BUTTON, d_visual_x, d_visual_y, d_visual_w, d_visual_h);
        ...
        */
        ...
        if (refresh) {
            ...
            */
            ...
            Fancy_Text_Print(
                TXT_SLOWER, d_scroll_x, d_scroll_y + d_scroll_h + (1 * RESFACTOR), scheme, TBLACK, TPF_TEXT);
            Fancy_Text_Print(TXT_FASTER,
