...
public:
    ...
    HRESULT Blit(GraphicViewPortClass& dest,
                 int x_pixel,
                 int y_pixel,
                 int dx_pixel,
                 int dy_pixel,
    ...
    HRESULT Blit(VideoViewPortClass& dest,
                 int x_pixel,
                 int y_pixel,
                 int dx_pixel,
                 int dy_pixel,
    ...
    HRESULT DD_Linear_Blit_To_Linear(GraphicViewPortClass& dest,
                                     int source_x,
                                     int source_y,
                                     int dest_x,
                                     int dest_y,
 ...
 *=========================================================================*/
inline void
GraphicViewPortClass::Draw_Stamp(void const* icondata, int icon, int x_pixel, int y_pixel, void const* remap)
{
    if (Lock()) {
...
inline void GraphicViewPortClass::Draw_Stamp(void const* icondata,
                                             int icon,
                                             int x_pixel,
                                             int y_pixel,
                                             void const* remap,
...
inline VOID GraphicViewPortClass::Fill_Quad(VOID* span_buff,
                                            int x0,
                                            int y0,
                                            int x1,
                                            int y1,
