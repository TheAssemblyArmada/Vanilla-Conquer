...
int MapEditClass::Placement_Dialog(void)
{
    ...
    TextButtonClass neutbtn(BUTTON_NEUTRAL,
                            "Neutral",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_NEUTRAL_X,
                            D_NEUTRAL_Y,
    ...
    TextButtonClass nextbtn(BUTTON_NEXT,
                            TXT_RIGHT,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_RIGHT_X,
                            D_RIGHT_Y,
    ...
    TextButtonClass prevbtn(BUTTON_PREV,
                            TXT_LEFT,
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_LEFT_X,
                            D_LEFT_Y,
    ...
    TextButtonClass templatebtn(BUTTON_TEMPLATE,
                                "Template",
                                TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                D_TEMPLATE_X,
                                D_TEMPLATE_Y,
    ...
    TextButtonClass overlaybtn(BUTTON_OVERLAY,
                               "Overlay",
                               TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                               D_OVERLAY_X,
                               D_OVERLAY_Y,
    ...
    TextButtonClass smudgebtn(BUTTON_SMUDGE,
                              "Smudge",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_SMUDGE_X,
                              D_SMUDGE_Y,
    ...
    TextButtonClass terrainbtn(BUTTON_TERRAIN,
                               "Terrain",
                               TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                               D_TERRAIN_X,
                               D_TERRAIN_Y,
    ...
    TextButtonClass unitbtn(BUTTON_UNIT,
                            "Unit",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_UNIT_X,
                            D_UNIT_Y,
    ...
    TextButtonClass infantrybtn(BUTTON_INFANTRY,
                                "Infantry",
                                TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                D_INFANTRY_X,
                                D_INFANTRY_Y,
    ...
    TextButtonClass aircraftbtn(BUTTON_AIRCRAFT,
                                "Aircraft",
                                TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                D_AIRCRAFT_X,
                                D_AIRCRAFT_Y,
    ...
    TextButtonClass buildingbtn(BUTTON_BUILDING,
                                "Building",
                                TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                D_BUILDING_X,
                                D_BUILDING_Y,
