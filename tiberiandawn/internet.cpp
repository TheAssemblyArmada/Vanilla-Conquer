    ...
    */
    ...
    if (!wchat_name || wchat_file.Is_Available()) {
        ...
        */
        ...
        WWGetPrivateProfileString("Internet", "Port", default_string, key_string, sizeof(key_string), ini_file);
        ...
        */
        ...
        WWGetPrivateProfileString("Internet", "Host", default_string, key_string, sizeof(key_string), ini_file);
 ...
 *                                                                         *
 * INPUT:                                                                  *
 *		name of C&CSPAWN.INI file. Null if data should be got from DDE server* * OUTPUT: * 1 = OK, 0 = error
 **
 *                                                                         *
 * WARNINGS:                          \                                     *
 *		none.																						*
...
int Read_Game_Options(char* name)
{
    ...
    MPlayerHouse = (HousesType)WWGetPrivateProfileInt("Options", "Side", HOUSE_GOOD, buffer);
