...
int MapEditClass::Edit_Team(void)
{
    ...
    TextButtonClass neubtn(BUTTON_NEU,
                           "NEUTRAL",
                           TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                           D_NEU_X,
                           D_NEU_Y,
    ...
    TextButtonClass roundbtn(BUTTON_ROUNDABOUT,
                             "Roundabout",
                             TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                             D_ROUNDABOUT_X,
                             D_ROUNDABOUT_Y,
    ...
    TextButtonClass learnbtn(BUTTON_LEARNING,
                             "Learning",
                             TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                             D_LEARNING_X,
                             D_LEARNING_Y,
    ...
    TextButtonClass suicidebtn(BUTTON_SUICIDE,
                               "Suicide",
                               TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                               D_SUICIDE_X,
                               D_SUICIDE_Y,
    ...
    TextButtonClass autocreatebtn(BUTTON_AUTO,
                                  "Autocreate",
                                  TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                  D_AUTOCREATE_X,
                                  D_AUTOCREATE_Y,
    ...
    TextButtonClass mercbtn(BUTTON_MERCENARY,
                            "Mercenary",
                            TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                            D_MERCENARY_X,
                            D_MERCENARY_Y,
    ...
    TextButtonClass prebuiltbtn(BUTTON_PREBUILT,
                                "Prebuild",
                                TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                D_PREBUILT_X,
                                D_PREBUILT_Y,
    ...
    TextButtonClass reinforcebtn(BUTTON_REINFORCE,
                                 "Reinforce",
                                 TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                                 D_REINFORCE_X,
                                 D_REINFORCE_Y,
    ...
    TextButtonClass insertbtn(BUTTON_INSERT,
                              "Insert",
                              TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                              D_INSERT_X,
                              D_INSERT_Y,
    ...
    TextButtonClass delbtn(BUTTON_DEL,
                           "Delete",
                           TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                           D_DEL_X,
                           D_DEL_Y,
    ...
    TextButtonClass membersbtn(BUTTON_MEMBERS,
                               "Members",
                               TPF_CENTER | TPF_6PT_GRAD | TPF_USE_GRAD_PAL | TPF_NOSHADOW,
                               D_MEMBERS_X,
                               D_MEMBERS_Y,
    ...
    while (process) {
        ...
        */
        ...
        case (BUTTON_MISSION2 | KN_BUTTON):
            if (missionlist2.Count() > 0 && missionlist2.Current_Index() != curmission) {
...
int MapEditClass::Team_Members(HousesType house)
{
    ...
    */
    if (house != HOUSE_GOOD && house != HOUSE_BAD && house != HOUSE_MULTI1 && house != HOUSE_MULTI2
        && house != HOUSE_MULTI3 && house != HOUSE_MULTI4) {
            ...
            if (display >= REDRAW_BACKGROUND) {
                ...
                */
                ...
                for (i = 0; i < maxclasses; i++) {
                    ...
                    //
                    Draw_Member(teamclass[i], i, teamcount[i], house, D_DIALOG_X + 16, dlg_picture_top);
                }
        ...
        if (lheld) {
            ...
            */
            if (TickCount.Time() - heldtime > tdelay[tindex]) {
                ...
                */
                Draw_Member(
                    teamclass[curclass], curclass, teamcount[curclass], house, D_DIALOG_X + 16, dlg_picture_top);
            }
    ...
    for (int i = 0; i < missioncount; i++) {
        ...
        */
        if (missions[i].Mission == TMISSION_MOVE || missions[i].Mission == TMISSION_UNLOAD) {
            ...
            */
            sprintf(
                missionbuf[i], "%s\t%d", TeamTypeClass::Name_From_Mission(missions[i].Mission), missions[i].Argument);
        }
