...
static BitMapHeaderType LocalHeader = {0x4001,
                                       0xc800,
                                       0,
                                       0,
                                       0,
                                       0, // width, height, x, y, planes, mask
                                       1,
                                       0,
                                       0xFF00,
                                       5,
                                       6, // compress, pad1, transcolor, xasptect, yaspect
                                       0x4001,
                                       0xC800}; // pagewidth, pageheight
...
static long CCWrite_BMHD(CCFileClass& lbmhandle, short bitplanes)
{
    ...
    return (lbmhandle.Write((char*)&LocalHeader, (sizeof(LocalHeader) + 1) & 0xFFFE) + 8L);
}
