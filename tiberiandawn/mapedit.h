...
enum MapEdit1Enum
{
    ...
    + (int)INFANTRY_COUNT + (int)AIRCRAFT_COUNT + (int)STRUCT_COUNT,

    MAX_TEAM_CLASSES = // max # ObjectTypeClasses for a team
    (int)UNIT_COUNT + (int)INFANTRY_COUNT + (int)AIRCRAFT_COUNT,

    NUM_EDIT_MISSIONS = 8, // # missions that can be assigned an object
...
public:
    ...
    */
    ...
    int Pick_Scenario(char const* caption,
                      int* scen_nump,
    ...
    */
    ...
    void Build_Mission_List(int missioncount,
